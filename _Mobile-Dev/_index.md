...
>
> 🎯 **Top-13 design picks (быстрый старт):** [`top-13-design-picks.md`](top-13-design-picks.md) — курируемая выборка с decision matrix и рекомендованными сочетаниями для разных сценариев.
